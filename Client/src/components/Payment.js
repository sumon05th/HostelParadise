...
function Payment() { // i get room details through Props here
...
const sendData={
     ...
     async function SendData(e){
        ...
        const res= await fetch("/feePayment",{
            method:"POST",
...
<LoginNav/>
    <div class="container">
      ...
      <div>
<h1>Make Payment to Continue further...</h1>
</div>
<form onSubmit={SendData}>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Room Number</label>
    <input type="text" class="form-control" id="exampleInputEmail1" name="roomNumber" value={Detail.RoomNumber} aria-describedby="emailHelp" disabled/>
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="number"  name="AmountPaid" value={Detail.feeAmount*month} class="form-control" id="exampleInputPassword1" disabled/>
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="number"  onChange={valueSetter} name="CVV" value={Data.CVV} class="form-control" id="exampleInputPassword1"/>
      ...
      {value!=="user"?<button type="submit" class="btn btn-primary">Pay</button>:<button type="submit" class="btn btn-primary" disabled>Pay</button>} 
